...
def extract_schedule():
    ...
    for i in index:
        try:
            ...
            response = requests.get(api_data, timeout=10)
            ...
            logging.error(f"Error fetching schedule for group {i}: {e}")
            continue
...
def update_teacher_sh():
    ...
    try:
        ...
        logging.info("Teacher schedule updated successfully.")
    except Exception as e:
        logging.error(f"Error updating teacher schedule: {e}")
